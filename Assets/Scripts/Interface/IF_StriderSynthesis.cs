...
{
    public class IF_StriderSynthesis : MonoBehaviour, IPointerDownHandler, IDragHandler
    {
        ...
        private Mode m_Mode;
        [SerializeField]
        private CR_StriderBase m_Walker;
        ...
        private void Awake()
        {
            ...
            {
                m_Walker = FindObjectOfType<CR_StriderBase>();
            }
        }
