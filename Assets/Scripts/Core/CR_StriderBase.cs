...
{
    public abstract class CR_StriderBase : CR_StriderCore, CR_IStriderHandler
    {
        ...
        protected UT_StriderChasis m_Body;
        protected UT_ChasisSkeleton[] m_Bones;
        
        protected UT_GroundRayDetection[] m_GroundRayDetectors;
        protected UT_GroundContactDetection[] m_GroundContactDetectors;
        ...
        public override void Initialize()
        {
            ...
            m_GroundRayDetectors = GetComponentsInChildren<UT_GroundRayDetection>();
            m_GroundContactDetectors = GetComponentsInChildren<UT_GroundContactDetection>();

            m_Body = GetComponentInChildren<UT_StriderChasis>();
            m_Body.Initialize();

            m_Bones = GetComponentsInChildren<UT_ChasisSkeleton>();
        ...
        public override void CollectObservations(VectorSensor sensor)
        {
            ...
            sensor.AddObservation(ML_Normalization.Sigmoid(m_Body.LocalVelocity));
            sensor.AddObservation(ML_Normalization.Sigmoid(m_Body.LocalAngularVelocity));
