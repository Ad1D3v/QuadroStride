...
{
    public class CR_StriderTitan : CR_StriderUpgrade
    {
        [SerializeField]
        ...
        protected override void PostAction() 
        {
            ...
            {
                if (UT_Helper.RandomBool(m_RandomKickProbability))
                {
        ...
        private void RandomizeTargets()
        {
            ...
            var lookDirXZ = UT_Helper.RandomBool(m_WalkLookSyncRatio) ? walkDirXZ : RandomDirection();
