...
{
    public class CR_StriderDummy : MonoBehaviour, CR_IStriderHandler
    {
        ...
        private void FixedUpdate()
        {
            if (m_IsActive)
            {
                ...
                m_Velocity.y = (c_Height - UT_Helper.GetHeightAboveGround(transform.position)) * c_ForceHeight;
        ...
        {
            if (collision.gameObject.layer == UT_ChasisLayer.Bullet)
            {
